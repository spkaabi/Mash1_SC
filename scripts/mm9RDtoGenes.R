...
#And create a filtered file of just the nearest for each peak.
...
write.csv(res.tss.nearest, file=paste(dirname(filename), "/res_tss_nearest.csv", sep=""), row.names=F)
...
write.csv(res.mirna.nearest, file=paste(dirname(filename), "/res_mirna_nearest.csv", sep=""), row.names=F)
...
write.csv(res.exon.nearest, file=paste(dirname(filename), "/res_exon_nearest.csv", sep=""), row.names=F)

...
task :upload_data, :roles => group_name do
    puts "rsync -e 'ssh -i /home/spkaabi/ec2/spkaabi.pem' -vzP data/* ubuntu@ec2-46-137-17-82.eu-west-1.compute.amazonaws.com:#{mount_point}" 
end
...
task :run_macs, :roles => group_name do
  ...
  control = "#{mount_point}/input_export_sorted_nodups.bam"
  genome = 'mm'
  bws = [300]
  pvalues = [0.00001]
